...
Another would be to use a simple rule: keep your eye on the ball and maintain a constant angle of gaze as you move. This mental shortcut - known as the gaze heuristic - works remarkably well. Yet this same strategy can lead you to run in a curved path rather than straight to where the ball will land. It might lead to to first run away and then run toward the landing point.
