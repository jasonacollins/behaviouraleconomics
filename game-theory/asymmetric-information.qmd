...
Sellers will sell a lemon if 𝑝≥5000 and a good car if $p\leq 10000$.

They will be able to sell the lemon if:

$$
5000\leq p\leq 7500+\mu7500
$$
...
1.  When buyers cannot observe product quality, given $p$, sellers have an incentive to lower product quality. That is, sellers try to pass off lemons.
