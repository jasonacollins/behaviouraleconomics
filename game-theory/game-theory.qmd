...
- And finally, the **payoffs**, which comprise a complete summary of the value to each player of each set of actions.
...
In non-cooperative games, players are not allowed to negotiate binding contracts. In cooperative games, players are allowed to negotiate binding contracts that allow them to implement joint strategies.
