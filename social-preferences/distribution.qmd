...
(1+2\alpha)x−10\alpha \quad &\textrm{if} \quad x \geq 5 \\[6pt]
(1−2\beta)x+10\beta \quad &\textrm{if} \quad x < 5 
\end{matrix}\right.
$$
...
![](img/dictator-game-distribution.png)
...
![](img/trust-game-example-payoffs.png)
...
![](img/trust-game-example-solved.png)
