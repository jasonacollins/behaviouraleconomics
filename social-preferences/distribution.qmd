...
![](img/public-goods-game-process-distribution.png)
...
![](img/public-goods-game-process-distribution-cooperate.png)

If neither contributes, each keeps their \$10. If one contributes \$10 and the other \$0, the \$15 pot is split equally so the contributor gets \$7.50 and the non-contributor gets \$17.50.

![](img/public-goods-game-process-distribution-defect.png)
...
In this version of the game, the dictator has a constrained choice set and must decide between the allocations (0, 1) and (1, 5), where $(x_D,x_R)$ represent the payoffs for the dictator and receiver, respectively. The dictator's $\alpha=1/2$. As the dictator has less than the other player under each distribution, $\alpha$ is the relevant parameter.
