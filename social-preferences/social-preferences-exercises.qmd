...
People tend to be more willing to see others have better outcomes when those others are worse off than them.
:::
...
Sigma must be negative such that the decrease in utility from agent $j$'s payoff is larger than that through the payoff Bob receives himself.
:::
