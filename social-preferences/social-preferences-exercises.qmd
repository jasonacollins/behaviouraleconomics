...
```{mermaid bezzle-nash}
%%| fig-width: 5
%%| label: fig-bezzle-nash
%%| fig-cap: Nash equilibrium
%%| mermaid-format: png

graph LR
    classDef default fill:#FFF
    A(Bezzle Bank) ---B[Contribute $50,000] --> C{Multplied by 2} --> D(Jason)
    A ---E((Contribute 0)) --> F["($0,0)"]
    D ---G[Proposal A] --> H["($50,000, $100,000)"]
    D ---I((Proposal B)) --> J["(-$50,000, $150,000)"]
