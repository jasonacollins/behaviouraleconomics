...
> For all $x$, $y$, $z$, if $x \succcurlyeq y$ and $y \succcurlyeq z$, then $x \succcurlyeq z$.
...
You could prefer less money to more. You could prefer sums of money that are divisible by seven with no remainder. You could prefer more for yourself or more for someone else.
