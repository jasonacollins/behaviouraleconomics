...
Consider these two simple streams of payoffs. Period $t_1=0$, which is now. Period $t_2=1$ is one year from today.

The first stream is \$100 now and nothing in a year. The second stream is nothing today and \$107 in one year.
