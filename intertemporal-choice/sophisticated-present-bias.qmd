...
The naive agent makes their plans by forward reasoning, starting from today ($t=0$).

1.  First, they decide their preferred option for $t=0$, believing that they will stick to their plan once they move to the next period.

2.  When they move to the next period ($t=1$) they recompute their preferred plan, again believing they will stick to the plan once they move to the next period.

3.  They repeat this process as they move through time.

In contrast, the sophisticated present-biased agent makes their plans by backward reasoning, starting from the final period ($t=T$).
