...
The following equation is an example of exponential discounting, with a stream of costs or benefits $x_0$ through to $x_T$ incurred at periods 0 through to $T$.
...
$U_0$ is utility of the stream of payoffs at time $t=0$. $x_t$ is the payoff in period $t$.
...
A second assumption is consumption independence.
...
A third assumption is stationary preferences.
...
A fourth assumption is utility independence.
