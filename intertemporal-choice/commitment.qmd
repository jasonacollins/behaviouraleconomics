...
```{=tex}
\begin{align*}
U(x)&=0+\beta\delta \times 0+\beta\delta^2\times 45 \\
&=0.5\times 45 \\
&=22.5
\end{align*}
```
...
```{=tex}
\begin{align*}
U(x)&=10+\beta\delta \times 10+\beta\delta^2\times 10 \\
...
```{=tex}
\begin{align*}
U(x)&=0+\beta\delta \times 20+\beta\delta^2\times 10 \\
...
```{=tex}
\begin{align*}
U(x)&=-1+\beta\delta \times 0+\beta\delta^2\times 45 \\
...
```{=tex}
\begin{align*}
U_0(smoking)&=\beta\delta\times 5 \\
&=2.5
\\
U_0(healthy)&=\beta\delta^2\times 8 \\
&=4
\end{align*}
```
...
```{=tex}
\begin{align*}
U_1(stickK+smoking)&=5-\beta\delta\times 5 \\
&=2.5
\\
U_1(stickK+healthy)&=\beta\delta\times 8 \\
&=4
\end{align*}
```
...
&=2.5
\\
U_0(stickK+healthy)&=\beta\delta^2\times 8 \\
&=4
\end{align*}
```
