...
The vertical bars represent the payments of \$100 and \$110. The lines projecting back from the bars to the y-axis represent the discounted utility of each payment at each time. There is a kink in the line projecting from the \$110 in two weeks, representing the effect of the short-term discount factor $\beta$.
