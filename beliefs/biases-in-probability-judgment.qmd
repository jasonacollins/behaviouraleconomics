...
&=\underbrace{\frac{P(X_2|H_1\cap T_2)P(H_1\cap T_2)}{P(X_2|H_1\cap T_2)P(H_1\cap T_2)+P(X_2|H_1\cap H_2)P(H_1\cap H_2)}}_{\text{Expanding the denominator using the formula for total probability}} \\[30pt]
&=\frac{1\times 0.25}{1\times 0.25+0.5\times 0.25} \\[12pt]
&=\frac{2}{3} \\[6pt]
\\
P(H_2|H_1\cap X_2 )&=\frac{P(X_2|H_1\cap H_2)P(H_1\cap H_2)}{P(H_1\cap X_2)} \\[12pt]
&=\underbrace{\frac{P(X_2|H_1\cap H_2)P(H_1\cap H_2)}{P(X_2|H_1\cap T_2)P(H_1\cap T_2)+P(X_2|H_1\cap H_2)P(H_1\cap H_2)}}_{\text{Expanding the denominator using the formula for total probability}} \\[30pt]
