...
Each outcome and the value of that outcome is marked: the premium payment $-R$ and the outcome after a bushfire $-H$. If uninsured and no fire, the agent will remain at their reference point of the status quo.
...
That is, an outcome with a probability of 0.001 is given a weight of 0.01, ten times what its probability would suggest. An outcome with a probability of 0.01 is given a weight of 0.05, five times the probability.

Similarly, a probability of 0.99 is given a weight of 0.95 and a probability of 0.999 is given a weight of 0.99, implying that probabilities near certainty are underweighted relative to certainty itself.
...
As the value of purchasing insurance is greater than the value of not purchasing insurance, $V(\text{I})>V(\neg\text{I})$, this person purchases insurance.  
