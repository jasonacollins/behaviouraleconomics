...
&=0.5v(110)+0.5v(-100) \\[6pt]
&=0.5\times (110)^{0.5}-0.5\times 2\times (100)^{0.5} \\[6pt]
...
\begin{align*}
V(A)&=p_1v(x_1)+p_2v(x_2) \\[6pt]
&=0.5v(110-100)-0.5v(-100-100) \\[6pt]
&=0.5\times (10)^{0.5}-0.5\times 2\times (200)^{0.5} \\[6pt]
...
\begin{align*}
V(A)&=p_1v(x_1)+p_2v(x_2) \\[6pt]
&=0.5v(10000+110)+0.5v(10000-100) \\[6pt]
...
\begin{align*}
V(\text{A})&=p_1v(x_1)+p_2v(x_2) \\
&=0.6\times v(-150+150)+0.4\times v(-150-100) \\
...
First, we calculate the expected value of purchasing the insurance.
...
Then we calculate the expected value of not purchasing the insurance.
...
First, we calculate the expected utility of purchasing the insurance, which is simply the utility of the wealth after the premium is paid.
