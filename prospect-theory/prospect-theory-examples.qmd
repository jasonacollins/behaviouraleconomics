...
The following chart shows Bill's choices before the shock, whereby all possible outcomes are in the gain domain. The possible outcomes from the gamble are zero and \$250. The certain outcome on offer is \$100. The expected value of the gamble is \$125.
