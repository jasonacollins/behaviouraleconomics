...
An agent is considering insurance against bushfire for its \$1,000,000 house. The house has a 1 in 1000 ($p=0.0001$) chance of burning down. An insurer is willing to offer full coverage for \$1100. (Note: \$1000 is the actuarially fair price, the additional \$100 might represent profit or administrative costs.)
...
The expected utility of not purchasing insurance is on the dash-dot line between $U(W-H)$ and $U(W)$. The precise point is $p$ along this line from $U(W)$ (or $1-p$ along the line from $U(W-H)$). This point aligns with the expected value of leaving the house uninsured $E[X]$.

The utility of purchasing insurance ($U(W-R)$) is greater than the expected utility of not purchasing insurance $(E[U(X)])$. The agent will purchase insurance.
...
ggplot(mapping = aes(x, y)) +
    ...
    annotate("text", x = 90, y = 0, label = "W", size = 4, hjust = 0.4, vjust = 1.5)+
    annotate("segment", x = 90, y = 0, xend = 90, yend = u(90), linewidth = 0.5, colour = "black", linetype="dotted")+
    annotate("segment", x = 0, y = u(90), xend = 90, yend = u(90), linewidth = 0.5, colour = "black", linetype="dotted")+
    annotate("text", x = 0, y = u(90), label = "U(W)", size = 4, hjust = 1.1, vjust = 0.4)+

    #Add labels W-R, U(W_R) and line to curve indicating each
    annotate("text", x = 70, y = 0, label = "W-R", size = 4, hjust = 0.5, vjust = 1.5)+
    annotate("segment", x = 70, y = 0, xend = 70, yend = u(70), linewidth = 0.5, colour = "black", linetype="dotted")+
    annotate("segment", x = 0, y = u(70), xend = 70, yend = u(70), linewidth = 0.5, colour = "black", linetype="dotted")+
    annotate("text", x = 0, y = u(70), label = "U(W-R)", size = 4, hjust = 1.05, vjust = 0.45)+

    #Add expected utility line
    annotate("segment", x = 90, xend = 3, y = u(90), yend = u(3), linewidth = 0.5, colour = "black", linetype="dotdash")+

    #Add labels W-H, U(W_H) and line to curve indicating each
    annotate("text", x = 3, y = 0, label = "W-H", size = 4, hjust = 0.4, vjust = 1.5)+
    annotate("segment", x = 3, y = 0, xend = 3, yend = u(3), linewidth = 0.5, colour = "black", linetype="dotted")+
    annotate("segment", x = 0, y = u(3), xend = 3, yend = u(3), linewidth = 0.5, colour = "black", linetype="dotted")+
    annotate("text", x = 0, y = u(3), label = "U(W-H)", size = 4, hjust = 1.05, vjust = 0.45)+

    #Add labels E[not I], E[U(X)] and curve indicating each
    annotate("text", x = 77, y = 0, label = "E[X]", size = 4, hjust = 0.4, vjust = 1.5)+
    annotate("segment", x = 77, y = 0, xend = 77, yend = u(3)+((u(90)-u(3))/(90-3))*74, linewidth = 0.5, colour = "black", linetype="dashed")+
    annotate("segment", x = 0, y = u(3)+((u(90)-u(3))/(90-3))*74, xend = 77, yend = u(3)+((u(90)-u(3))/(90-3))*74, linewidth = 0.5, colour = "black", linetype="dashed")+
    annotate("text", x = 0, y = u(3)+((u(90)-u(3))/(90-3))*74, label = "E[U(X)]", size = 4, hjust = 1.05, vjust = 0.45)
