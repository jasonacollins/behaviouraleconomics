...
@kahneman1979 describes the editing phase as having four main operations: coding, combination, segregation and cancellation.

-   In the coding phase, prospects are coded as gains or losses relative to a reference point.

-   In the combination phase, prospects are simplified by combining probabilities for identical outcomes. For example, (0.25, 200; 0.25, 200; 0.50, 0) will become (0.50, 200; 0.50, 0).

-   During segregation, riskless components are segregated from risky components. For example (0.80, 300; 0.20, 200) corresponds to a sure gain of 200 and the risky gamble (0.80, 100; 0.20, 0, 0).
...
| **Low probability**        | Rick seeking  | Risk aversion |
