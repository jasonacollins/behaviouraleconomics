...
As an example example, suppose someone is given \$100. If their initial reference point is their wealth before receiving the \$100, $x$ will be \$100. Therefore their change in value is +100. If the same person instead loses \$100, their change in value would be -200.
