...
The greater slope of the curve in the loss domain, leading to kink where the axes intercept, is indicative of the greater effect of losses.
...
We can calculate this by calculating what payment $\$p$ would make Bruce indifferent between losing the mug and gaining \$p. We assume a reference point for money of his current wealth and are instructed that his reference point for mugs is ownership of the mug.
...
We can calculate this by calculating what payment $\$p$ would make Bruce indifferent between gaining the mug and losing \$p. We assume a reference point for money of his current wealth and are instructed that his reference point for mugs is no mug.
