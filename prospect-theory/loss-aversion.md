...
::: {.cell-output-display}
![](loss-aversion_files/figure-html/unnamed-chunk-1-1.png){width=672}
:::
:::
...
Assume Bruce was not given a mug, but rather an opportunity to purchase a mug. How much would Bruce be willing to pay for the mug?
