...
- Prospect theory also has a probability weighting function, whereby objective probabilities are subjectively weighted by the agent. Small probabilities are weighted relatively more heavily than moderate probabilities. Those weights are then applied to the value of each outcome. 
