...
i) Will Tim want to play this gamble?
...
&=`r 0.5*250^(1/2)-0.5*2*100^(1/2)`
\end{align*}

Tim has negative value from the gamble, when he could simply have zero value by declining. He rejects.
:::

ii) Explain what features of the value function lead him to accept or reject the gamble.
...
There are two forces under prospect theory that would lead Amber to take the option with the lower expected value:
