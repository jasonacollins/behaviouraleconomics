...
In these notes I take a traditional approach to behavioural economics, providing the basic economics foundations and examining how modifications to the core economic axioms lead to new insight. There is ample critique of the field (as you can read [here](https://www.jasoncollins.blog/a-critical-behavioural-economics-and-behavioural-science-reading-list/)), but these course notes are not about that critique. Those foundations can be the launchpad for a critique, and without understanding those foundations the critique can be hollow.
