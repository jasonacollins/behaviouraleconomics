...
The Allais paradox is one of the most famous anomalies of expected utility theory.

The paradox emerges from the pattern of response to two pairs of bets.
...
This is a contradiction. Under expected utility theory, if an agent chooses A it should choose C. And if the agent chooses B it should choose D. This phenomenon is called the Allais Paradox after Maurice @allais1953, who first identified it.
