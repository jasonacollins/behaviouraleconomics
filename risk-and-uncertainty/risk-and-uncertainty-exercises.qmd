...
b\) Suppose an agent has a logarithmic utility function ($U(x)=\ln(x)$) and they have \$10,000 in cash in addition to their house, giving them wealth ($W$) of \$1,010,000. 
...
c\) Would this agent with logarithmic utility purchase the insurance? 
